...
// req.open("POST", "http://localhost:8888/OpenClassrooms/Javascript/javascript-web/javascript-web-srv/post_form.php");
...
// ajaxPost("http://localhost:8888/OpenClassrooms/Javascript/javascript-web/javascript-web-srv/post_form.php", commande, function(reponse){
...
form.addEventListener("submit", function (e) {
    ...
    ajaxPost("http://localhost:8888/OpenClassrooms/Javascript/javascript-web/javascript-web-srv/post_form.php", data, function (reponse) {
      console.log(reponse);
    }, false);
});
...
// ajaxPost("http://localhost:8888/OpenClassrooms/Javascript/javascript-web/javascript-web-srv/post_json.php", film,
//     function (reponse) {
