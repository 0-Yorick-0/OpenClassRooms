		...
		<main>
			...
			<section id="formulaire">
				<form action="minichat_post.php" method="post" >
                    ...
                    ?>
					<label for="message">Message : </label><br /><input class="champsmessage" type="text" name="message" id="message" ro required/><br />
					<input type="submit" value="Envoyer" />
				</form>
			</section>
			<section id="chat">
               <a href="minichat.php">Afficher moins de messages</a>
                <?php
            // connection MySQL
            ...
            // requette
				$reponse = $bdd->query('SELECT pseudo, message, DATE_FORMAT(date_ajout, "%d %m %Y à %Hh%imin%ss") AS date_creation FROM minichat ORDER BY ID DESC');
